...
public class CssBoardListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		// totalCnt
		int totalCnt = bdao.getCssBoardCnt();
		...
		request.setAttribute("boardList", bdao.getCssBoardList(startRow, endRow));

		forward.setRedirect(false);
		forward.setPath(request.getContextPath() + "/app/pages/css.jsp");
