...
public class MemberReportedAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		request.setAttribute("userBlockedList", mdao.userBlockedList(startRow, endRow));

		forward.setRedirect(false);
		forward.setPath(request.getContextPath() + "/app/pages/admin_blocked_member.jsp");
