                                    ...
                                    <div class="reply_box mt-5">
                                       ...
                                       <c:if test="${sessionScope.session_id != null }" >
                                          <div valign="top" style="padding-left: 10px;">
                                             ...
                                             <a class="btn btn-info" href="javascript:updateReadonlyReply( ${reply.reply_id} );">수정 하기</a>
                                             <a class="btn btn-primary" href="javascript:updateReply( ${reply.reply_id})">수정 완료</a>
